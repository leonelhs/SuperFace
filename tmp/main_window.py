...
class ImagePanel:
    def __init__(self, splitter):
        ...
        self.layout = QVBoxLayout(self.scroll_contents)
        self.layout.setContentsMargins(0, 0, 0, 0)

        self.image = QLabel(self.scroll_contents)
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self, main_window):
        ...
        self.inputPanel = ImageGrid(self.splitter)
        self.outputPanel = ImageGrid(self.splitter)
        ...
        self.folder_open.triggered.connect(self.load_folder)
        ...
        self.face_marks.triggered.connect(self.process_marks)
    ...
    def load_file(self):
        ...
        self.inputPanel.appendThumbnail(self.image_path)

    def load_folder(self):
        self.folder_path = QFileDialog.getExistingDirectory(self, 'Open folder')
        self.show_message("Working folder at: ", self.image_path)
        self.inputPanel.append_images(self.folder_path)
    ...
    def process_marks(self):
        image = faces_detect(self.image_path)
        self.show_message("Faces detected", "")
        display_image(image, self.outputPanel.face)
