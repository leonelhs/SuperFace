...
class ToolBoxEnhancer(ToolBoxMaker):
    ...
    def buildPages(self):
        ...
        self.addButton("zero", "Segment image", self.toolset_ai.processSegmentation)
        ...
        self.addButton("makeup", " Makeup face", self.toolset_ai.processFaceMakeup)
    ...
    def pageZeroBackground(self):
        self.addButton("zero", "Remove background", self.toolset_ai.processZeroBackground)
        self.addButton("zero", "Custom background", self.toolset_ai.setCustomBackground)
