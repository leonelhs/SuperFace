...
from AI.Pytorch.zero_scratches.detection_models.antialiasing import Downsample
from AI.Pytorch.zero_scratches.detection_models.sync_batchnorm import DataParallelWithCallback
