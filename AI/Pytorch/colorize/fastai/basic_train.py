    ...
    try:
        for epoch in pbar:
            ...
            for xb, yb in progress_bar(learn.data.train_dl, parent=pbar):
                ...
                loss = loss_batch(learn.model, xb, yb, learn.loss_func, learn.opt, cb_handler, count=count,
...
class Learner:
    ...
    def predict(self, item: ItemBase, return_x: bool = False, batch_first: bool = True, with_dropout: bool = False,
                **kwargs):
...
class Recorder(LearnerCallback):
    ...
    def plot_lr(self, show_moms=False, skip_start: int = 0, skip_end: int = 0, return_fig: bool = None) -> Optional[
        plt.Figure]:
